 ...
 * @category Models
 */
export declare type WalletContractType = 'SafeMultisigWallet' | 'SafeMultisigWallet24h' | 'SetcodeMultisigWallet' | 'SetcodeMultisigWallet24h' | 'BridgeMultisigWallet' | 'SurfWallet' | 'WalletV3';
/**
 * @category Models
 */
 ...
 * @category Models
 */
export declare type TransactionWithAccount<Addr = Address> = Transaction<Addr> & {
    account: Addr;
};
/**
 * @category Models
 ...
 * @category Models
 */
export declare type DelayedMessage<Addr = Address> = {
    /**
...
declare type AbiParamKindUint = 'uint8' | 'uint16' | 'uint24' | 'uint32' | 'uint64' | 'uint128' | 'uint160' | 'uint256';
declare type AbiParamKindInt = 'int8' | 'int16' | 'int24' | 'int32' | 'int64' | 'int128' | 'int160' | 'int256';
...
declare type AbiParamKindFixedBytes = `fixedbytes${NonZeroDigit | `${'1' | '2'}${Digit}` | '30' | '31' | '32'}`;
...
declare type NonZeroDigit = '1' | '2' | '3' | '4' | '5' | '6' | '7' | '8' | '9';
/**
 * @category Models
 */
export declare type AbiParamKind = AbiParamKindUint | AbiParamKindInt | AbiParamKindTuple | AbiParamKindBool | AbiParamKindCell | AbiParamKindAddress | AbiParamKindBytes | AbiParamKindFixedBytes | AbiParamKindString | AbiParamKindGram | AbiParamKindTime | AbiParamKindExpire | AbiParamKindPublicKey;
/**
 * @category Models
 */
 ...
 * @category Models
 */
export declare type AbiFunctionInputsWithDefault<C, T extends AbiFunctionName<C>> = PickFunction<C, T>['inputs'] extends readonly [] ? void | Record<string, never> : AbiFunctionInputs<C, T>;
/**
 * @category Models
 */
