...
export declare const DEFAULT_NETWORK_GROUP = "mainnet";
/**
 * @category Client
 */
export declare const NETWORK_PRESETS: {
    readonly mainnet: ConnectionData;
    readonly mainnetJrpc: ConnectionData;
    readonly testnet: ConnectionData;
 ...
 * @category Client
 */
export declare type ConnectionProperties = (keyof typeof NETWORK_PRESETS) | ConnectionData;
/**
 ...
 * @category Client
 */
export declare type InitializedTransport = {
    id: number;
    group: string;
} & ({
    type: 'graphql';
